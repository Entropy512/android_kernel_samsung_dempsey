		...
		unsigned int relation)
{
	...
	/*
	 * Don't jump directly to 1.2 GHz
	 */
	if (index == L0) {
	  if (old_index > L1) index = L1;
	  if (old_index > L2) index = L2;
	}
...
ssize_t show_UV_mV_table(struct cpufreq_policy *policy, char *buf) {
	return sprintf(buf, "1200mhz: %lu mV\n1000mhz: %lu mV\n800mhz: %lu mV\n400mhz: %lu mV\n200mhz: %lu mV\n100mhz: %lu mV\n", dvs_conf[0].arm_volt/1000,
		dvs_conf[1].arm_volt/1000, dvs_conf[2].arm_volt/1000, dvs_conf[3].arm_volt/1000, dvs_conf[4].arm_volt/1000,
		dvs_conf[5].arm_volt/1000);
}

...
{ 
   ...
   /* for 244e */
   uint8_t atchfrccalthr;         /*!< recalibration suspend time after last detection */
   uint8_t atchfrccalratio;       /*!< Anti-touch calibration suspend threshold */
...
typedef struct
{
   ...
   uint8_t gclimitmin;
   uint8_t gclimitmax;
   uint16_t gccountmintgt; // 20, 21
   uint8_t mfinvlddiffthr;
   uint16_t mfincadcspxthr; // 23, 24
   uint16_t mferrorthr; // 25, 26
   uint8_t selfreqmax;	// 27
   uint8_t reserved10;   
   uint8_t reserved11;
   uint8_t reserved12;
   uint8_t reserved13;
   ...
   uint8_t reserved15;
	...
	uint8_t blen;            /*!< Sets the gain of the analog circuits in front of the ADC. The gain should be set in
	    						ction with the burst length to optimize the signal acquisition. Maximum gain values for
							given object/burst length can be obtained following a full calibration of the system. GAIN
							s a maximum setting of 4; settings above 4 are capped at 4.*/
	uint8_t tchthr;          /*!< ACMASK Threshold for all object channels   */
	uint8_t tchdi;           /*!< Detect integration config           */

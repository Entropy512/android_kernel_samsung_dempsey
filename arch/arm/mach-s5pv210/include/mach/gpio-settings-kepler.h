...
//#if defined(CONFIG_KEPLER_AUDIO_A1026)
#if defined (CONFIG_S5PC110_KEPLER_BOARD)
//parkhj	{S5PV210_GPH1(0), S3C_GPIO_OUTPUT,	S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE},
...
#else
// parkhj	{S5PV210_GPH1(7), S3C_GPIO_INPUT,	S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE},
#endif
...
//parkhj	{S5PV210_GPH3(1), S3C_GPIO_INPUT,	S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_UP}, //GPIO_KBR1
//parkhj		{S5PV210_GPH3(2), S3C_GPIO_INPUT,	S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_UP}, //GPIO_KBR2
//parkhj		{S5PV210_GPH3(3), S3C_GPIO_INPUT,	S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN},	//GPIO_KBR3

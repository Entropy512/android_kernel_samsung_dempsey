...
#define V4L2_CID_CAMERA_EXIF_FW_VER		(V4L2_CID_CAMERA_CLASS_BASE + 30)
...
enum v4l2_zoom_level {
	...
	ZOOM_LEVEL_11,
	ZOOM_LEVEL_12,
#if defined(CONFIG_VIDEO_M5MO)  //NAGSM_ANDROID_HQ_CAMERA_SUNGKOOLEE_20101119
	ZOOM_LEVEL_MAX = 31,
#else
	ZOOM_LEVEL_MAX,
#endif
...
#if defined(CONFIG_VIDEO_M5MO) //NAGSM_ANDROID_HQ_CAMERA_SoojinKim_20110202
	FOCUS_MODE_TOUCH,
...
#define V4L2_CID_CAM_AF_ZERO_STEP				(V4L2_CID_PRIVATE_BASE+126) //NAGSM_ANDROID_HQ_CAMERA_SoojinKim_20110122
#endif
